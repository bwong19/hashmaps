 ...
 */
public class HashMapLinearTomb<K, V> implements Map<K, V> {
    ...
    private int hash(K key) {
        ...
        return (key.hashCode() + this.capacity()) % this.capacity();
    }
    ...
    private class HashMapIterator<K, V> implements Iterator<K> {
        ...
        public K next() {
            ...
            while (HashMapLinearTomb.this.data[this.i] == null) {
                this.i++;
            }
            this.n++;
            int retEle = this.i;
            i++;
            return (K) HashMapLinearTomb.this.data[retEle].key;
        }

        @Override
        public boolean hasNext() {
            return (this.n) < HashMapLinearTomb.this.size;
        }
