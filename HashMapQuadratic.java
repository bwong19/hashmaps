 ...
 */
public class HashMapQuadratic<K, V> implements Map<K, V> {
    ...
    private class HashMapIterator<K, V> implements Iterator<K> {
        ...
        public K next() {
            ...
            while (HashMapQuadratic.this.data[this.i] == null) {
                this.i++;
            }
            this.n++;
            int retEle = this.i;
            i++;
            return (K) HashMapQuadratic.this.data[retEle].key;
        }

        @Override
        public boolean hasNext() {
            return (this.n) < HashMapQuadratic.this.size;
        }
